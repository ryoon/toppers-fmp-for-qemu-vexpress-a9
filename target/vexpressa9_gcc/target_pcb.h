 ...
 *
 *  This file contains the target-dependent definitions of
 *  the processor control block (PCB). In particular it allows
 *  configuring the locking method used in the kernel.
 */
...
/*
 *  Include chip-dependent code (MPCORE)
 */
#include "arm_gcc/mpcore/chip_pcb.h"
